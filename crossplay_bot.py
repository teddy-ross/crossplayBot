...
def run_gui(dictionary: Dictionary) -> None:
    ...
    root = tk.Tk()
    root.title("Crossplay Bot -- Best Move Finder")
    ...
    tk.Label(main_frame, text="CROSSPLAY BOT",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="NYT Crossplay Bot -- finds the best move from your board state",
    )
    ...
    print("=" * 60)
    print("  NYT CROSSPLAY BOT -- Best Move Finder")
    print("=" * 60)
